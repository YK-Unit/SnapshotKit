...
Pod::Spec.new do |s|
  s.name             = 'SnapshotKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SnapshotKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yorkzhang520/SnapshotKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yorkzhang520' => 'yorkzhang520@gmail.com' }
  s.source           = { :git => 'https://github.com/yorkzhang520/SnapshotKit.git', :tag => s.version.to_s }
